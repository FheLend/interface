    ...
    >
      ...
      <Container maxW="container.md" minH="calc(100vh - 80px)" display="flex">
        <Center flexDir="column" textAlign="center">
          <GradientText fontSize="xxx-large" fontWeight="bold">
            Empowering Confidential and Secure Crypto Lending
          </GradientText>
          <Text color="whiteAlpha.700" px="10" my="7" lineHeight="30px">
          ...
          <Button as={Link} href="/dashboard" w="200px">
            Launch App
          </Button>
        </Center>
      </Container>
      ...
      <Container maxW="container.lg" mt="300px" p="0">
